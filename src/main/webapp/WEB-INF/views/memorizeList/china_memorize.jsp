...
<!DOCTYPE HTML>
<%
	ArrayList<WordTO> chinaList = (ArrayList) request.getAttribute("chinaList");
...
<body>
	...
	<div>
		<a href="ememorize.do"><button class="btn btn">English</button></a>
		<a href="jmemorize.do"><button class="btn btn">Japanese</button></a>
		<a href="cmemorize.do"><button class="btn btn" style="background-color: orangered;">Chinese</button></a>
	</div>
