...
<!DOCTYPE HTML>
<%
	ArrayList<WordTO> japanList = (ArrayList) request.getAttribute("japanList");
...
<body>
	...
	<div>
		...
		<a href="jmemorize.do"><button class="btn btn" style="background-color: orangered;">Japanese</button></a>
